...
public class ComposeFragment extends Fragment {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photoFile == null || ivPostImage.getDrawable() == null) {
                    Toast.makeText(getContext(), "No image for post", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                Toast.makeText(getContext(), "Posted to timeline", Toast.LENGTH_SHORT).show();
    ...
    public void onLaunchCamera(View view) {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.shantanoo.parstagram.fileprovider", photoFile);
